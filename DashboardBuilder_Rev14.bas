...
Private Sub BuildKPICards()
    ...
    ' Card 6: Escalated (no date filter --" it's a manual status flag; exclude Completed/Cancelled/Non IQ)
    ...
    ' Card 7: Watched (no date filter --" it's a manual status flag; exclude Completed/Cancelled/Non IQ)
    If m_escCol > 0 And m_groupCol > 0 Then
